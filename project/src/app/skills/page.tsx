        ...
        <div className="skills-contents">
          <div id="skills-container">
            <div className="bar">
              <div className="info">
                <Image
                  src="https://img.icons8.com/?size=100&id=7ej5ASIwdQXG&format=png&color=000000"
                  alt="skill"
                  width={48}
                  height={48}
                />
            ...
            <div className="bar">
              <div className="info">
                <Image
                  src="https://img.icons8.com/?size=100&id=B1VZ9ZRl8Vwt&format=png&color=FFFFFF"
                  alt="skill"
                  width={48}
                  height={48}
                />
            ...
            <div className="bar">
              <div className="info">
                <Image
                  src="https://img.icons8.com/offices/48/000000/php-logo.png"
                  alt="skill"
                  width={48}
                  height={48}
                />
            ...
            <div className="bar">
              <div className="info">
                <Image
                  src="https://img.icons8.com/?size=100&id=nrY6pkbRkJCi&format=png&color=000000"
                  alt="skill"
                  width={48}
                  height={48}
                />
            ...
            <div className="bar">
              <div className="info">
                <Image
                  src="https://img.icons8.com/?size=100&id=19313&format=png&color=000000"
                  alt="skill"
                  width={48}
                  height={48}
                />
            ...
            <div className="bar">
              <div className="info">
                <Image
                  src="https://img.icons8.com/?size=100&id=13677&format=png&color=000000"
                  alt="skill"
                  width={48}
                  height={48}
                />
            ...
            <div className="bar">
              <div className="info">
                <Image
                  src="https://img.icons8.com/?size=100&id=e57Y1CnsOasB&format=png&color=000000"
                  alt="skill"
                  width={48}
                  height={48}
                />
